...
const projectsData = [
  ...
  //   github: '',
  //   blog: '',
  //   tags: ['QA', 'Functional Testing', 'Manual Testing', 'Bug Reporting'],
  // },
  // {
  //   title: 'Qtec Corporate Website QA',
  //   description: 'Conducted end-to-end QA analysis on Qtec’s staging website. Identified navigation, content, and UI/UX issues across devices and browsers, focusing on usability, responsiveness, and accessibility.',
  //   imageURL: '/qtec-website-qa.png',
  //   github: '',
  //   blog: '',
  //   tags: ['QA', 'UI/UX', 'Responsive Testing', 'Manual Testing', 'Accessibility'],
  // },
  {
